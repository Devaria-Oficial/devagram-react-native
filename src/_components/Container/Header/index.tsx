                ...
                <View style={styles.containerProfile}>
                    ...
                    <View style={{ marginHorizontal: 16 }}>
                        <TouchableOpacity onPress={() => props.editProfileHeader?.submitEnable && props.editProfileHeader?.submit()}>
                            <Text style={props.editProfileHeader.submitEnable ? styles.textSubmit : styles.textSubmitDisabled}>Concluir</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            }
                ...
                <View style={styles.containerProfile}>
                    ...
                    <View style={{ marginHorizontal: 16 }}>
                        <TouchableOpacity onPress={() => props.publicationHeader?.submitEnable && props.publicationHeader?.submit()}>
                            <Text style={props.publicationHeader.submitEnable ? styles.textSubmit : styles.textSubmitDisabled}>Compartilhar</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            }
